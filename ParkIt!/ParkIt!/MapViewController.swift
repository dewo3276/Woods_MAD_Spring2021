...
class MapViewController: UIViewController, CLLocationManagerDelegate{
    ...
    var selectedCoords = [String](arrayLiteral: "hello","test")
    ...
    func viewPreviousLocation(){
        let location = CLLocationCoordinate2DMake(Double(selectedCoords[0])!, Double(selectedCoords[1])!)
        ...
        var pinDropped = MKPointAnnotation()
