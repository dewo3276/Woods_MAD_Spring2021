...
class ParkingHistoryTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text=locationHistory[indexPath.row*2]+" "+locationHistory[(indexPath.row*2)+1]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Varriables.selectedCoords[0]=(locationHistory[(indexPath.row)*2])
        Varriables.selectedCoords[1]=(locationHistory[((indexPath.row)*2)+1])
        Varriables.didAppearFromTableView=true
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            ...
            parkingData.deleteData(index: indexPath.row)
